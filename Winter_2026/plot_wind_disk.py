...
fp = "Winter_2026/Data/wind_model/test_1Myrs_vfrag=50_psi=10.json"
fp2 = "Winter_2026/Data/wind_model/test_1Myrs_highres_psi=10.json"
...
fig.savefig(f"Winter_2026/Figs/wind_model/test2_1Myrs_psi={psi}.png")
...
if len(time) > 1:
    ...
    ax_flux.set_ylabel('Pebble Flux', fontsize=14)
    ...
    ani.save(f"Winter_2026/Figs/wind_model/pebble_flux2_1Myrs_animation_psi={psi}.gif", writer=PillowWriter(fps=2))
    plt.close(fig_flux)
